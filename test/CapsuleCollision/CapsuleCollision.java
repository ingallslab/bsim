...
public class CapsuleCollision {
    ...
    private static String executionPath = CapsuleCollision.class.getProtectionDomain().getCodeSource().getLocation().getPath();
    ...
    final double width = 50.0; //1389 pixels = 100 um
    ...
    final ArrayList<CapsuleCollisionBacterium> bacA = new ArrayList();
    final ArrayList<CapsuleCollisionBacterium> bacB = new ArrayList();
    ...
    final ArrayList<CapsuleCollisionBacterium> bac_bornA = new ArrayList();
    final ArrayList<CapsuleCollisionBacterium> bac_bornB = new ArrayList();

    final ArrayList<CapsuleCollisionBacterium> bac_deadA = new ArrayList();
    final ArrayList<CapsuleCollisionBacterium> bac_deadB = new ArrayList();
    ...
    public static void main(String[] args) {
    	...
    	CapsuleCollision bsim_ex = new CapsuleCollision();
    ...
    public static CapsuleCollisionBacterium createBacterium(BSim sim) {
        ...
        CapsuleCollisionBacterium bacterium = new CapsuleCollisionBacterium(sim, pos1, pos2);
    ...
    public void run() {
        ...
        String systemPath = projectDirectory+"/simulations/CapsuleCollision";
        ...
        while ( bacteriaAll.size() < initialPopulation ) {
            ...
            CapsuleCollisionBacterium bacteriumA = createBacterium( sim);
            CapsuleCollisionBacterium bacteriumB = createBacterium( sim );
        ...
        CapsuleCollisionTicker ticker = new CapsuleCollisionTicker(sim, bacA, bacB, bacteriaAll, LOG_INTERVAL, bacRng,
        ...
        CapsuleCollisionDrawer drawer = new CapsuleCollisionDrawer(sim, drawerWidth, drawerHeight,
        		bacA, bacB);
